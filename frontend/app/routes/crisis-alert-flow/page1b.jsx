        ...
        <div style={{ 
          ...
          <div>
            ...
            <textarea
              ...
              placeholder="Provide detailed information about the situation, what customers should expect, and any actions they need to take..."
              style={{
                width: '100%',
                minHeight: '200px',
                padding: '1rem',
            ...
            <button
              type="button"
              onClick={() => navigate('/crisis-alert-flow/page1b')}
              style={{
                display: 'flex',
                alignItems: 'center',
                gap: 8,
